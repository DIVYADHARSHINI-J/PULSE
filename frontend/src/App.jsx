        ...
        <section className="poll-showcase">
          ...
          <div className="poll-card">
            ...
            <div className="poll-top">
              ...
              <span className="poll-time">Just now</span>
            </div>

            <div className="poll-content">

              <p className="poll-label">QUICK QUESTION</p>
      ...
      <section id="features" className="features">
        ...
        <div className="feature">
          ...
          <div>
            ...
            <p>Results update as people vote.</p>
          </div>
        </div>
        ...
        <div className="feature">
          ...
          <div>
            ...
            <p>One link is all your audience needs.</p>
          </div>
        </div>
        ...
        <div className="feature">
          ...
          <div>
            ...
            <p>Clean screens without unnecessary clutter.</p>
          </div>
        </div>
      ...
      <section id="how-it-works" className="how-it-works">
        ...
        <div className="steps">
          ...
          <div className="step">
            <span>01</span>
            <h3>Create</h3>
            <p>Write your question and add your options.</p>
          </div>

          <div className="step">
            <span>02</span>
            <h3>Share</h3>
            <p>Send your poll link to your audience.</p>
          </div>

          <div className="step">
            <span>03</span>
            <h3>Watch</h3>
            <p>See responses change in real time.</p>
          </div>
...
function PollOption({ text, percentage, width, selected }) {
  return (
